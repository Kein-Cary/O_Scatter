...
for t in range(1,N):
    ...
    plt.savefig('snap_fig/MUSIC gas distribution No_%.0f_z_%.0f.png' %(_id_, t), dpi=600)
    plt.show()
    plt.close()
    plt.figure()
    if view_id == 1:
    ...
    plt.savefig('snap_fig/MUSIC DM distribution No_%.0f_z_%.0f.png' %(_id_, t), dpi=600)
    plt.show()
    plt.close()
    plt.figure()
    try:
        if N_star_MU[t] != 0:
            ...
            plt.savefig('snap_fig/MUSIC star distribution No_%.0f_z_%.0f.png' %(_id_, t), dpi=600)
            plt.show()
            plt.close()
    except ValueError:
    ...
    plt.savefig('snap_fig/MUSIC Multi-distribution No_%.0f_z_%.0f.png' %(_id_, t), dpi=600)
    plt.show()
    plt.close()
    plt.figure()
    if view_id == 1:
    ...
    plt.ylabel(r'$r-kpc/h$')
    plt.title(r'$GadgetMUSIC_{%.0f}-z_{%.3f} Re_{%.3f}$' % (plane_id,comz[t-1], resolution))
    plt.savefig('snap_fig/MUSIC Multi-center No_%.0f_z_%.0f.png' % (_id_, t), dpi=600)
    plt.show()
    plt.close()
...
for t in range(1,M):
    ...
    plt.savefig('snap_fig/GX gas distribution No_%.0f_z_%.0f.png' % (_id_, t), dpi = 600)
    plt.show()
    plt.close()
    plt.figure()
    if view_id == 1:
    ...
    plt.savefig('snap_fig/GX DM distribution No_%.0f_z_%.0f.png' % (_id_, t), dpi = 600)
    plt.show()
    plt.close()
    plt.figure()
    try:
        if N_star_GX[t] != 0:
            ...
            plt.savefig('snap_fig/GX star distribution No_%.0f_z_%.0f.png' % (_id_, t), dpi = 600)
            plt.show()
            plt.close()
    except ValueError:
        print('Now is no enough star particles!')
    ...
    plt.savefig('snap_fig/GX Multi-distribution No_%.0f_z_%.0f.png' % (_id_, t), dpi=600)
    plt.show()
    plt.close()
    plt.figure()
    if view_id == 1:
    ...
    plt.ylabel(r'$r-kpc/h$')
    plt.title(r'$GadgetX_{%.0f}-z_{%.3f} Re_{%.3f}$' % (plane_id, comz_gx[t-1], resolution))
    plt.savefig('snap_fig/GX Multi-center No_%.0f_z_%.0f.png' % (_id_, t), dpi=600)
    plt.show()
    plt.close()
L = np.min([N,M])
for t in range(1,L):
    ...
    try:
        ...
        plt.title(r'$GadgetX_{%.0f}-z_{%.3f}-Re_{%.3f}$' % (plane_id,comz_gx[t-1], resolution))
        plt.tight_layout()
        plt.savefig('snap_fig/Image halo_%.0f particle snap_%.0f.png' %(_id_, t), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
    except ValueError:
...
for t in range(1,L):
    ...
    try:
        ...
        plt.title(r'$GadgetX_{%.0f}-z_{%.3f}-Re_{%.3f}$' % (plane_id,comz_gx[t-1], resolution))
        plt.tight_layout()
        plt.savefig('snap_fig/Image halo_%.0f center snap_%.0f.png' % (_id_, t), dpi=600)
        plt.show()
        plt.close()          
    except ValueError:
        break