...
for k in range(len(z_mu)):
    try:
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/gas_overdens_T_distribution_MU%.0f.png'%k,dpi = 600)
        plt.show() 
        plt.close()
        ...
        plt.title(r'$SFR-\rho_{gas}-h%.0f-z_{%.3f}-MU$'%(_id_,z_mu[k]))
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/SFR_rho_gas_mhalo_MU%.0f.png'%k,dpi=600)
        plt.show()
        plt.close()
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/gas_density_T_mhalo_MU%.0f.png'%k,dpi = 600)
        plt.show()
        plt.close()
    except KeyError:
...
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/temperatur_profile_BCG_MU%.0f.png'%_id_,dpi = 600)
plt.show()
plt.close()
############################
...
for k in range(len(z_gx)):
    try:
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/gas_overdens_temperatur_distribution_GX%.0f.png'%k,dpi = 600)
        plt.show() 
        plt.close()
        ...
        plt.title(r'$SFR-\rho_{gas}-h%.0f-z_{%.3f}-GX$'%(_id_,z_gx[k]))
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/SFR_rho_gas_mhalo_GX%.0f.png'%k,dpi=600)
        plt.show()
        plt.close()
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/gas_density_T_mhalo_GX%.0f.png'%k,dpi = 600)
        plt.show()
        plt.close() 
    except KeyError:
...
plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)     
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/temperatur_profile_BCG_GX%.0f.png'%_id_,dpi = 600)
plt.show()
plt.close()
