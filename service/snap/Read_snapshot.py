...
for k in range(len(alpha)):
    ...
    if snap_z <= 1.0:
        ...
        if snap_N[-2] != 0:
            ...
            plt.savefig(
            '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC star distribution z_%.0f.png' % dd, dpi=600)
            plt.show()
            plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC gas distribution z_%.0f.png' % dd, dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC DM distribution z_%.0f.png' % dd, dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if snap_N[-1] !=0:
            ...
            plt.savefig(
            '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC boundary distribution z_%.0f.png'% dd,dpi=600)
            plt.show()
            plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC disk distribution z_%.0f.png'% dd,dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC bulge distribution z_%.0f.png'% dd,dpi=600)
        plt.show()
        plt.close()
        '''
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC_gas_distribution_No_%.0f_z_%.0f.png' %(_id_, dd), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if view_id == 1:
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC_DM_distribution_No_%.0f_z_%.0f.png' %(_id_, dd), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if snap_N[-2] != 0:
            ...
            plt.savefig(
                    '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC_star_distribution_No_%.0f_z_%.0f.png' %(_id_, dd), dpi=600)
            plt.show()
            plt.close()
        # multi-distribution
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC_Multi-distribution_No_%.0f_z_%.0f.png' %(_id_, dd), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if view_id == 1:
        ...
        plt.title(r'$GadgetMUSIC_{%.0f}-z_{%.3f} Re_{%.3f}$' % (plane_id,snap_z, resolution))
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/MUSIC_Multi-center_No_%.0f_z_%.0f.png' % (_id_, dd), dpi=600)
        plt.show()
        plt.close()
    ...
    if snap_z_gx <= 1.0:
        ...
        if snap_N_gx[-2] != 0:
            ...
            plt.savefig(
            '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_star_distribution_z_%.0f.png' % dd, dpi = 600)
            plt.show()
            plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_gas_distribution_z_%.0f.png' % dd, dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_DM_distribution_z_%.0f.png' % dd, dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if snap_N_gx[-1] !=0:
            ...
            plt.savefig(
            '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_boundary_distribution_z_%.0f.png'%dd,dpi=600)
            plt.show()
            plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_disk_distribution_z_%.0f.png'%dd,dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        ...
        plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_bulge_distribution_z_%.0f.png'%dd,dpi=600)
        plt.show()
        plt.close()
        '''
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_gas_distribution_No_%.0f_z_%.0f.png' % (_id_, dd), dpi = 600)
        plt.show()
        plt.close()
        plt.figure()
        if view_id == 1:
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_DM_distribution_No_%.0f_z_%.0f.png' % (_id_, dd), dpi = 600)
        plt.show()
        plt.close()
        plt.figure()
        if snap_N[-2] != 0:
            ...
            plt.savefig(
                    '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_star_distribution_No_%.0f_z_%.0f.png' % (_id_, dd), dpi = 600)
            plt.show()
            plt.close()
        # multi-distribution
        plt.figure(figsize=(8, 8))
        ...
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_Multi-distribution_No_%.0f_z_%.0f.png' % (_id_, dd), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        if view_id == 1:
        ...
        plt.title(r'$GadgetX_{%.0f}-z_{%.3f} Re_{%.3f}$' % (plane_id, snap_z_gx, resolution))
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/GX_Multi-center_No_%.0f_z_%.0f.png' % (_id_, dd), dpi=600)
        plt.show()
        plt.close()
    #comparation of the two simulation
    if snap_z <= 1.0 and snap_z_gx <= 1.0:
        ...
        plt.tight_layout()
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/Image_halo_%.0f_particle_snap_%.0f.png' %(_id_,dd), dpi=600)
        plt.show()
        plt.close()
        plt.figure()
        plt.subplot(1, 2, 1)
        ...
        plt.tight_layout()
        plt.savefig(
                '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/snap_fig_1/Image_halo_%.0f_center_snap_%.0f.png' % (_id_,dd), dpi=600)
        plt.show()
        plt.close()
#return
#fig_snap(ip=True,resolution=True,viewp=True)