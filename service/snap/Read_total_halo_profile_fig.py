...
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/Halo_density_profile_evolution_MU.png',dpi = 600)
plt.show()
plt.close()
#####
...
plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/Halo_mean_density_profile_evolution_MU.png',dpi = 600)
plt.show()
plt.close()
...
plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/Halo_density_profile_evolution_GX.png',dpi = 600)
plt.show()
plt.close() 
...
plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/Halo_mean_density_profile_evolution_GX.png',dpi = 600)
plt.show()
plt.close() 
