...
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/temperatur_profile_BCG MU%.0f.png'%_id_,dpi = 600)
plt.show()
plt.close()
...
plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)     
plt.savefig(
        '/mnt/ddnfs/data_users/cxkttwl/Scatter_data_read/snap/T_SFR/temperatur_profile_BCG_GX%.0f'%_id_,dpi = 600)
plt.show()
plt.close()
