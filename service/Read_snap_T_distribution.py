...
for k in range(len(alpha)):
    ...
    if snap_z <= id_z:
        ...
        main_halo = asc.read(
                '/home/cxkttwl/Scatter_data_read/MUSIC_reshift/NewMDCLUSTER_0001/GadgetMUSIC-NewMDCLUSTER_0001.z%.3f.AHF_halos'%snap_z,
        ...
        try:
            ...
            main_profile = pd.read_table(
                    '/home/cxkttwl/Scatter_data_read/MUSIC_reshift/NewMDCLUSTER_0001/GadgetMUSIC-NewMDCLUSTER_0001.z%.3f.AHF_profiles'%snap_z,
                                         dtype = np.float)
            ...
            with h5py.File('main%.0f_halo_rho_T_z%.3f_MU.h5'%(_id_,snap_z),'w') as f:
                f['a'] = array3
            with h5py.File('main%.0f_halo_rho_T_z%.3f_MU.h5'%(_id_,snap_z)) as f:
            ...
            with h5py.File('meanT_R_h%.0f_z%.3f_MU.h5'%(_id_,snap_z),'w') as f:
                f['a'] = array4
            with h5py.File('meanT_R_h%.0f_z%.3f_MU.h5'%(_id_,snap_z)) as f:
            ...
            try:
                ...
                with h5py.File('BCG_T_R_h%.0f_z%.3f_MU.h5'%(_id_,snap_z),'w') as f:
                    f['a'] = array5
                with h5py.File('BCG_T_R_h%.0f_z%.3f_MU.h5'%(_id_,snap_z)) as f:
...
for k in range(len(alpha)):
    ...
    if snap_z <= id_z_gx:
        ...
        main_halo_gx = asc.read(
                '/home/cxkttwl/Scatter_data_read/G_x_redshift/NewMDCLUSTER_0001/GadgetX-NewMDCLUSTER_0001.z%.3f.AHF_halos'%snap_z,
                             converters={'col1':[asc.convert_numpy(np.int64)], 'col2':[asc.convert_numpy(np.int64)]})
        ...
        try:
            ...
            #figure the temperature distribution of main halo 
            main_profile = pd.read_table(
                    '/home/cxkttwl/Scatter_data_read/G_x_redshift/NewMDCLUSTER_0001/GadgetX-NewMDCLUSTER_0001.z%.3f.AHF_profiles'%snap_z,
                                         dtype = np.float)
            r = np.array(main_profile['#r(1)'])
            r = np.abs(r)
            if check_id == 0:
            ...
            with h5py.File('main%.0f_halo_rho_T_z%.3f_GX.h5'%(_id_,snap_z),'w') as f:
                f['a'] = array3_gx
            with h5py.File('main%.0f_halo_rho_T_z%.3f_GX.h5'%(_id_,snap_z)) as f:
            ...
            with h5py.File('meanT_R_h%.0f_z%.3f_GX.h5'%(_id_,snap_z),'w') as f:
                f['a'] = array4_gx
            with h5py.File('meanT_R_h%.0f_z%.3f_GX.h5'%(_id_,snap_z)) as f:
            ...
            try:
                ...
                with h5py.File('BCG_T_R_h%.0f_z%.3f_GX.h5'%(_id_,snap_z),'w') as f:
                    f['a'] = array5_gx
                with h5py.File('BCG_T_R_h%.0f_z%.3f_GX.h5'%(_id_,snap_z)) as f:
