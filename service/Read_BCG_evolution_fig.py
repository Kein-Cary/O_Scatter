...
def fig_BCG(resolution,g_size):
    ...
    eta_s = m_s/m_tot
    eta_g = m_g/m_tot
    with h5py.File('BCG_%.0f_rho_MU_%.3f.h5'%(size_BCG,resolution)) as f:
        rho = np.array(f['a'])
    rho_s = np.array(rho[0,:])
    rho_g = np.array(rho[1,:])
    rho_b = rho_s + rho_g
    with h5py.File('BCG_%.0f_mrho_MU_%.3f.h5'%(size_BCG,resolution)) as f:
        m_rho = np.array(f['a'])
    ...
    with h5py.File('BCG_%.0f_rho_GX_%.3f.h5'%(size_BCG,resolution)) as f:
        rho_gx = np.array(f['a'])
    rho_s_gx = np.array(rho_gx[0,:])
    rho_g_gx = np.array(rho_gx[1,:])
    rho_b_gx = rho_s_gx + rho_g_gx
    with h5py.File('BCG_%.0f_mrho_GX_%.3f.h5'%(size_BCG,resolution)) as f:
    ...
    plt.savefig('BCG mass growth',dpi = 600)
    plt.show()
    plt.close()
    ...
    plt.savefig('BCG mass ratio',dpi = 600)
    plt.show()
    plt.close()
    ...
    for k in range(N_color):
        if k % 8 == 0:
            ax1.plot(r_mu[:-1],rho_b[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\rho_b-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    ax1.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
    ...
    ax1.set_yscale('log')
    ax1.set_xscale('log')
    #plt.title(r'$BCG-\rho_b-r-MU-Re_{%.3f}$'%resolution)
    #plt.savefig('BCG baryon profile evolution MU')
    #plt.show()
    #plt.close()
    #plt.figure(figsize = (8,9))
    for k in range(N_color):
        if k % 8 == 0:
            ax2.plot(r_mu[:-1],rho_s[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\rho_\ast-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    ax2.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #ax2.set_yscale('log')
    ax2.set_title(r'$BCG-\rho_\ast-r-MU-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color):
        if k % 8 == 0:
            ax3.plot(r_mu[:-1],rho_g[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\rho_g-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    ax3.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #ax3.set_yscale('log')
    #ax3.set_title(r'$BCG-\rho_g-r-MU-Re_{%.3f}$'%resolution)
    #plt.savefig('BCG gas profile evolution MU')
    #plt.show()
    #plt.close()
    plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
    plt.savefig('BCG density profile evolution MU',dpi = 600)
    plt.show()
    plt.close()
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            bx1.plot(r_gx[:-1],rho_b_gx[k,:],'--',color = mpl.cm.rainbow(k/N_color_gx),
                     label = r'$\rho_b-{%.3f}$'%z_gx[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    bx1.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    bx1.set_yscale('log')
    bx1.set_xscale('log')
    #plt.title(r'$BCG-\rho_b-r-GX-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            bx2.plot(r_gx[:-1],rho_s_gx[k,:],'--',color = mpl.cm.rainbow(k/N_color_gx),
                     label = r'$\rho_\ast-{%.3f}$'%z_gx[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    bx2.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #bx2.set_yscale('log')
    bx2.set_title(r'$BCG-\rho_\ast-r-GX-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            bx3.plot(r_gx[:-1],rho_g_gx[k,:],'--',color = mpl.cm.rainbow(k/N_color_gx),
                     label = r'$\rho_g-{%.3f}$'%z_gx[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    bx3.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #bx3.set_yscale('log')
    #plt.title(r'$BCG-\rho_g-r-GX-Re_{%.3f}$'%resolution)
    #plt.savefig('BCG gas profile evolution GX')
    #plt.show()
    #plt.close()
    plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
    plt.savefig('BCG density profile evolution GX',dpi = 600)
    plt.show()
    plt.close()
#################
    N_color = np.int0(len(z_mu)) 
    ...
    for k in range(N_color):
        if k % 8 == 0:
            cx1.plot(r_mu,m_rho_b[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\bar{\rho_b}-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    cx1.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    cx1.set_yscale('log')
    cx1.set_xscale('log')
    #plt.title(r'$BCG-\bar{\rho_b}-r-MU-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color):
        if k % 8 == 0:
            cx2.plot(r_mu,m_rho_s[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\bar{\rho_\ast}-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    cx2.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #cx2.set_yscale('log')
    cx2.set_title(r'$BCG-\bar{\rho_\ast}-r-MU-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color):
        if k % 8 == 0:
            cx3.plot(r_mu,m_rho_g[k,:],'--',color = mpl.cm.rainbow(k/N_color),
                     label = r'$\bar{\rho_g}-{%.3f}$'%z_mu[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    cx3.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #cx3.set_yscale('log')
    #cx3.set_title(r'$BCG-\bar{\rho_g}-r-MU-Re_{%.3f}$'%resolution)
    #plt.savefig('BCG mean gas profile evolution MU')
    #plt.show()
    #plt.close()
    plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
    plt.savefig('BCG mean density profile evolution MU',dpi = 600)
    plt.show()
    plt.close()
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            dx1.plot(r_gx,m_rho_b_gx[k,:],'--',color = mpl.cm.rainbow(k/N_color_gx),
                     label = r'$\bar{\rho_b}-{%.3f}$'%z_gx[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    dx1.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    dx1.set_yscale('log')
    dx1.set_xscale('log')
    #plt.title(r'$BCG-\bar{\rho_b}-r-GX-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            dx2.plot(r_gx,m_rho_s_gx[k,:],'--',color = mpl.cm.rainbow(k/N_color_gx),
                     label = r'$\bar{\rho_\ast}-{%.3f}$'%z_gx[k])
            handles, labels = plt.gca().get_legend_handles_labels() 
    dx2.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #dx2.set_yscale('log')
    dx2.set_title(r'$BCG-\bar{\rho_\ast}-r-GX-Re_{%.3f}$'%resolution)
    ...
    for k in range(N_color_gx):
        if k % 8 == 0:
            ...
            handles, labels = plt.gca().get_legend_handles_labels() 
    dx3.legend(bbox_to_anchor=(-0.05, 1., 1.15, 0.), loc=4,
               ncol= 6, mode="expand", fontsize=7.5, borderaxespad=2.)
    ...
    #dx3.set_yscale('log')
    #plt.title(r'$BCG-\bar{\rho_g}-r-GX-Re_{%.3f}$'%resolution)
    #plt.savefig('BCG mean gas profile evolution GX')
    #plt.show()
    #plt.close()
    plt.tight_layout(pad=0.5, h_pad=0., w_pad=-1)
    plt.savefig('BCG mean density profile evolution GX',dpi = 600)
    plt.show()
    plt.close()
    return
